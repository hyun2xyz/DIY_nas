...
그래서 문득 ‘작업실에 놀고 있는 사양 좋은 데스크탑으로 만들면 되는 거 아닌가?’라는 생각에서 가볍게 시작했어요. 몇가지 제약을 두었는데요 안드레 카파시의 바이브 코딩으로 단 한 줄의 코딩 없이 오로지 자연어로 그리고 오픈소스로만, 중요한 건 모르는 단어는 그냥 넘기지 않고 그 개념원리를 시간을 들여 공부하고 정리했습니다.  내가 지금 뭘 하고 있는지 파악해야 하니까요.
